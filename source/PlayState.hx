...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			var bgd:BGSprite = new BGSprite('gameplaybg/wangsaf', -600, -200, 0.9, 0.9);
			add(bgd);
			...
			case 'maghrib':
			var bruh:BGSprite = new BGSprite('gameplaybg/mountainmaghrib', -1000, -200, 0.9, 0.9);
			add(bruh);

			var shitman:BGSprite = new BGSprite('gameplaybg/treemaghrib', -1000, -200, 0.9, 0.9);
			add(shitman);
		...
		add(strumLineNotes); //i lined this to do bob onslaught modchart
		add(grpNoteSplashes);
		...
		botplaTxt = new FlxText(400, timeBarBG.y - 140, FlxG.width - 800, "Flip Your Keyboard!", 32);
		botplaTxt.setFormat(Paths.font("vcr.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		botplaTxt.scrollFactor.set();
		botplaTxt.borderSize = 1.25;
		botplaTxt.visible = cpuControlled;
		// add(botplaTxt);
		if(ClientPrefs.downScroll) {
			botplaTxt.y = timeBarBG.y - 140;
  ...
  public function clearShaderFromCamera(cam:String){
	...
	override function beatHit()
	{
		...
		if(SONG.song.toLowerCase() == "archipelago") {
			if(curBeat == 133) {
