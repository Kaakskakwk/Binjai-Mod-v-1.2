...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		blackScreen = new FlxSprite().loadGraphic(Paths.image('oren'));
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Mod', 'From'], -40);
				case 7:
					addMoreText('This Game', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				case 9:
					addMoreText('OH NOOO', -40);
					ngSpr.visible = false;
				case 10:
					deleteCoolText();
					lime.app.Application.current.window.alert('Error : u have Skill Issue');
				// credTextShit.visible = false;
